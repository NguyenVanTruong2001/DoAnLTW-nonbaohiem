                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <div class="d-flex justify-content-center">
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-primary"></i> Mũ 3/4 đầu
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-success"></i> Mũ full-face
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-info"></i> Mũ 1/2 đầu
                                            </span>
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <span class="mr-2">
                                                <i class="fas fa-circle" style="color: #ff1493"></i> Mũ lật cằm
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle" style="color: #ff8c00"></i> Mũ trẻ em
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle" style="color: #ffd700"></i> Mũ xe đạp
                                            </span>
                                        </div>
                                    </div>
                                </div>
