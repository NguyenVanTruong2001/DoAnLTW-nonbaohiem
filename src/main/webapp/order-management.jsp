                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="orderTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="orderDetail-management?orderId=<%= bean.getOrderId() %>" class="btn btn-dark my-1" style="background-color: #36b9cc; color: #f8f9fc">
                                            <i class="fas fa-info"></i>
                                        </a>
                                        <a href="form-order?orderId=<%= bean.getOrderId() %>" class="btn btn-dark" style="background-color: #1cc88a; color: #f8f9fc">
